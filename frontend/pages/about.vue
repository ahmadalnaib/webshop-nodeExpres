<!-- <template>
   <div :style="{ backgroundColor: about?.color || '#f0f0f0' }" class="container mx-auto p-4 min-h-screen">

    <div v-if="about">
      <img :src="about.photo" alt="About Photo" class="mb-4">
...
const fetchAbout = async () => {
  try {
    const response = await axios.get('http://localhost:8001/api/about');
...
<template>
  <div class="bg-white" :style="{ backgroundColor: about?.color || '#f0f0f0' }">
    ...
    <main class="isolate">
        ...
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
            <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
              <div v-if="about">
                <p class="text-xl leading-8 text-gray-600">{{ about.text }}</p>
      ...
      <!-- Image section -->
      <div class="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8" v-if="about">
        <img :src="about.photo"  alt="" class="aspect-[5/2] w-full object-cover xl:rounded-3xl" />
      </div>
