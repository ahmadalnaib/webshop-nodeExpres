  ...
  <div class="bg-white">
    ...
    <div class="relative bg-gray-900">
      ...
      <div class="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
        ...
        <nuxt-link to="/products/products" class="mt-8 inline-block rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100">Shop New Arrivals</nuxt-link>
      </div>
    </div>
